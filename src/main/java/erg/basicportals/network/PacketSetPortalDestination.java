...
public class PacketSetPortalDestination {
    ...
    public void handle(Supplier<NetworkEvent.Context> ctx) {
        if(!(ctx.get().getSender().getServerWorld().getTileEntity(pos) instanceof TileEntityPortalBase)) {
        ...
        ctx.get().enqueueWork(() -> {
            ...
            TileEntityPortalBase tileEntityPortalBase = (TileEntityPortalBase)world.getTileEntity(this.pos);
