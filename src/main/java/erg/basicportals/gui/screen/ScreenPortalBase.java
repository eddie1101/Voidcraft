package erg.basicportals.gui.screen;
...
public class ScreenPortalBase extends ContainerScreen<ContainerPortalBase> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("basicportals", "textures/gui/portalbase_inventory.png");
